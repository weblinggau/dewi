	              ...
	              <!-- Illustrations -->
	                <div class="card shadow mb-4">
	                  <div class="card-header py-3">
	                    <h6 class="m-0 font-weight-bold text-primary">Selamat Datang Kembali di halaman <?php if ($this->session->userdata('role') == '1') {echo "Admin";}elseif($this->session->userdata('role') == '2'){echo "Pengelola";}?></h6>
	                  </div>
	                  <div class="card-body">
